...
variable "agent_urls" {
  description = "Comma-separated agent_name=url pairs for AE-deployed agents (gateway AGENT_URLS env). Populated by Phase 4.5 cloud-build collect-ae-urls step."
  type        = string
  default     = ""
}
