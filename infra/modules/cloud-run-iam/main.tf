...
# ---------------------------------------------------------------------------
# Frontend: optional public access for the demo. Gated by
# var.frontend_unauthenticated so production-like deployments can lock
# it down behind IAP or per-user OIDC instead.
# ---------------------------------------------------------------------------
resource "google_cloud_run_v2_service_iam_member" "frontend_public" {
  count = var.frontend_unauthenticated ? 1 : 0
