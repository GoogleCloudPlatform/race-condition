...
tool, plus the following 5 memory tools:
...
Same as planner_with_eval (Section 8.4). The planner composes a marathon
dashboard A2UI card generatively via the `a2ui-rendering` shared skill.
