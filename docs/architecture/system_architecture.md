...
This document tracks the high-level architecture of the Race Condition backend, including both the high-performance telemetry pipeline in Go and the agent-to-agent distributed network in Python.
