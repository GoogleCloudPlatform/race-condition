...
This document defines the local developer port allocation strategy for the `n26-devkey-simulation-code` project to ensure stability, discoverability, and organization.
