  ...
  data: {
    surfaceUpdate: {
      ...
      components: [
        {
          id: 'tag-1',
          component: { Text: { text: { literalString: 'STORED' }, usageHint: 'label' } },
        },
        {
          id: 'meta-1',
          component: {
            Text: { text: { literalString: '#dd82 2026-04-16' }, usageHint: 'caption' },
          },
        },
        {
          id: 'tag-row-1',
          component: { Row: { children: { explicitList: ['tag-1', 'meta-1'] } } },
        },
        {
          id: 'title-1',
          component: {
            Text: {
              text: { literalString: 'Las Vegas Neon & Neighborhoods Marathon' },
              usageHint: 'h2',
            },
          },
        },
        ...
        {
          id: 'bar-right-1',
          component: { Text: { text: { literalString: 'SCORE 83%' }, usageHint: 'caption' } },
        },
        {
          id: 'bar-1',
          component: { Row: { children: { explicitList: ['bar-left-1', 'bar-right-1'] } } },
        },
        {
          id: 'dist-l-1',
        ...
        {
          id: 'spec-r-1',
          component: { Row: { children: { explicitList: ['spec-l-1', 'spec-v-1'] } } },
        },
        {
          id: 'peak-l-1',
          component: { Text: { text: { literalString: 'Peak Hour Volume' }, usageHint: 'body' } },
        },
        {
          id: 'peak-v-1',
          component: { Text: { text: { literalString: '—' }, usageHint: 'body' } },
        ...
        {
          id: 'peak-r-1',
          component: { Row: { children: { explicitList: ['peak-l-1', 'peak-v-1'] } } },
        },
        ...
        {
          id: 'run-l-1',
          component: { Text: { text: { literalString: 'Runner Experience' }, usageHint: 'body' } },
        },
        ...
        {
          id: 'city-l-1',
          component: { Text: { text: { literalString: 'City Disruption' }, usageHint: 'body' } },
        },
        {
          id: 'city-v-1',
          component: { Text: { text: { literalString: '—' }, usageHint: 'body' } },
        ...
        {
          id: 'btn-row-1',
          component: { Row: { children: { explicitList: ['osc-btn-1', 'sr-btn-1'] } } },
        },
        {
          id: 'content-1',
          component: {
        ...
        },
        {
          id: 'meta-2',
          component: {
            Text: { text: { literalString: '#seed 2026-02-10' }, usageHint: 'caption' },
          },
        },
        {
          id: 'tag-row-2',
          component: { Row: { children: { explicitList: ['tag-2', 'meta-2'] } } },
        },
        {
          id: 'title-2',
          component: { Text: { text: { literalString: 'Grand Loop' }, usageHint: 'h2' } },
        },
        {
          id: 'left-col-2',
        ...
        {
          id: 'bar-2',
          component: { Row: { children: { explicitList: ['bar-left-2', 'bar-right-2'] } } },
        },
        {
          id: 'dist-l-2',
          component: { Text: { text: { literalString: 'Total distance' }, usageHint: 'body' } },
        ...
        {
          id: 'spec-r-2',
          component: { Row: { children: { explicitList: ['spec-l-2', 'spec-v-2'] } } },
        },
        {
          id: 'peak-l-2',
          component: { Text: { text: { literalString: 'Peak Hour Volume' }, usageHint: 'body' } },
        ...
        {
          id: 'peak-r-2',
          component: { Row: { children: { explicitList: ['peak-l-2', 'peak-v-2'] } } },
        },
        ...
        { id: 'run-v-2', component: { Text: { text: { literalString: '—' }, usageHint: 'body' } } },
        {
          id: 'run-r-2',
        ...
        { id: 'sr-txt-2', component: { Text: { text: { literalString: 'Show Route' } } } },
        {
          ...
          component: {
            Button: {
              child: 'sr-txt-2',
              action: { name: 'show_route', payload: { seed: 'seed-0004-grand-loop-m3n4o5p6' } },
              primary: { literalBoolean: true },
            },
          },
        },
        {
          id: 'btn-row-2',
          component: { Row: { children: { explicitList: ['osc-btn-2', 'sr-btn-2'] } } },
        },
        {
          id: 'content-2',
          component: {
        ...
        },
        {
          id: 'meta-3',
          component: {
            Text: { text: { literalString: '#seed 2026-02-01' }, usageHint: 'caption' },
          },
        },
        {
          id: 'tag-row-3',
          component: { Row: { children: { explicitList: ['tag-3', 'meta-3'] } } },
        },
        {
          id: 'title-3',
          component: { Text: { text: { literalString: 'East Side Explorer' }, usageHint: 'h2' } },
        },
        {
          id: 'left-col-3',
        ...
        {
          id: 'bar-right-3',
          component: { Text: { text: { literalString: 'SCORE 78%' }, usageHint: 'caption' } },
        },
        {
          id: 'bar-3',
          component: { Row: { children: { explicitList: ['bar-left-3', 'bar-right-3'] } } },
        },
        {
          id: 'dist-l-3',
          component: { Text: { text: { literalString: 'Total distance' }, usageHint: 'body' } },
        ...
        {
          id: 'spec-r-3',
          component: { Row: { children: { explicitList: ['spec-l-3', 'spec-v-3'] } } },
        },
        {
          id: 'peak-l-3',
          component: { Text: { text: { literalString: 'Peak Hour Volume' }, usageHint: 'body' } },
        ...
        {
          id: 'peak-r-3',
          component: { Row: { children: { explicitList: ['peak-l-3', 'peak-v-3'] } } },
        },
        ...
        { id: 'run-v-3', component: { Text: { text: { literalString: '—' }, usageHint: 'body' } } },
        {
          id: 'run-r-3',
        ...
        {
          id: 'btn-row-3',
          component: { Row: { children: { explicitList: ['osc-btn-3', 'sr-btn-3'] } } },
        },
        {
          id: 'content-3',
          component: {
