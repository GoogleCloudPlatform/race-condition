...
export const DEMO_HOTKEYS = ['0', '1', '2', '3', '4', '5', '7', 'd', 'r'];
...
export const DEMO_IDS = ['CI', '1', '2', '3', '4', '5', '7'] as const;
...
export const EXAMPLE_RUNNER_THOUGHTS = [
  'Vegas is beautiful',
  'I might move here',
  'Just keep swimming',
  'I can do this!',
  'Glad my family is here',
  'Wow my time is great',
];
export const EXAMPLE_DNF_RUNNER_THOUGHTS = [
  "I'm just too tired",
  "Next time I'll do better!",
  "I'll be back!",
  'I nap here.',
];
export const EXAMPLE_LOW_VITAL_RUNNER_THOUGHTS = [
  'NEED. WATER. NOW.',
  "I can't continue for much longer",
  "I'm pushing it...",
