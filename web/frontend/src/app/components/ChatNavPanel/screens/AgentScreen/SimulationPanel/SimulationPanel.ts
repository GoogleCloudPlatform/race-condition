  ...
  template: `
    <div class="sim-panel-wrapper">
      <div class="simulation-running-panel">
        ...
        <div class="distance">
          <div class="stat">
            <p class="value">{{ averageDistance }}</p>
            <p class="label">AVG. DISTANCE (miles)</p>
          </div>
        </div>
        <div class="statistics">
          ...
          <div class="stat">
            <p class="value">{{ numberOfRaceAbandoners }}</p>
            <p class="label">DID NOT FINISH</p>
          </div>
          <div class="stat">
            <p class="value">{{ averagePace }}</p>
            <p class="label">AVG. PACE (min/mile)</p>
          </div>
          <div class="stat">
            <p class="value">{{ averageWater }}%</p>
            <p class="label">AVG. ENERGY LEVEL</p>
          </div>
        </div>
...
export class SimulationPanelComponent {
  ...
  @Input() numberOfRaceAbandoners = 0;
  @Input() averagePace = '0:00';
  @Input() averageWater = 0;
