...
export const DEMO_CONFIG: DemoConfigType = {
          ...
          components: [
            ...
            },
            {
              ...
              component: {
                Text: {
                  text: {
                    literalString: '#7f5b  27/04/23  08:00:00 PM',
                  },
                  usageHint: 'caption',
                },
              },
  ...
  '2': {
    ...
    promptPlaceholder: 'Plan a marathon in Las Vegas for 10,000 runners',
    recordingConfig: {
      cachedMessageStreams: ['/assets/sim-2-log.ndjson', '/assets/run-100runners.ndjson'],
      timeScale: 4,
    },
  },
  '3': {
    ...
    promptPlaceholder: 'Plan a marathon in Las Vegas for 10,000 runners',
    recordingConfig: {
      cachedMessageStreams: ['/assets/sim-3-log.ndjson', '/assets/run-100runners.ndjson'],
      timeScale: 6,
    },
  },
  '4': {
  ...
  '5a': {
    title: 'Intent to infrastructure with Gemini Cloud Assist (Standard)',
  ...
  '7a': {
    title: 'Securing agents (Not secure)',
    agent: 'planner_with_memory',
    promptPlaceholder:
