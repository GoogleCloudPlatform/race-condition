...
from agents.utils.plugins import BaseDashLogPlugin, RedisDashLogPlugin
...
PluginCls = type[RedisDashLogPlugin]
...
@pytest.mark.asyncio
@pytest.mark.parametrize("plugin_cls", [RedisDashLogPlugin])
