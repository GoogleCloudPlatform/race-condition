...
async def prepare_simulation(
    ...
    logger.error("Internal error in simulation engine.")
    raise RuntimeError(
        "Internal Server Error: an unexpected exception occurred while "
        "processing the request. Please contact the system administrator "
