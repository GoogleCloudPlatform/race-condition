...
class TestCollectReportingRunners:
    ...
    def test_collect_reporting_runners_passes_messages_without_tick(self):
        """Messages without tick field should pass through (backward compat)."""
        msg_no_tick = {
            "session_id": "runner-1",
            "payload": {
                "tool_name": "process_tick",
        ...
        dest: set[str] = set()
        _collect_reporting_runners([msg_no_tick], dest, current_tick=3)
        assert dest == {"runner-1"}
