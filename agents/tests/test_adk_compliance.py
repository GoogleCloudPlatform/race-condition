...
TOOL_MODULES = [
    "agents.npc.runner.skills.hydration.tools",
    "agents.npc.runner.skills.running.tools",
    "agents.npc.runner_autopilot.skills.hydration.tools",
    "agents.npc.runner_autopilot.skills.running.tools",
