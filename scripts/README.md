...
scripts/
  ...
  oss/        Open-source release sync tooling
...
| `sync_alloydb.sh` | -- | Syncs AlloyDB data from dev to production (regulations, routes, simulation records) |
...
| `test_sim_docker.py` | `core/sim.py` (Docker lifecycle, container pruning, stop safety) |
