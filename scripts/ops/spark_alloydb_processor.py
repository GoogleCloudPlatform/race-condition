...
def main():
    ...
    # -------------------------------------------------------------
    # Adapt DataFrame to match the AlloyDB `regulations` table schema
    ...
    if is_local:
        ...
        target_table = f"{alloydb_schema}.regulations"
        ...
        with pool.connect() as db_conn:
             # Appending strictly to "regulations" since our connection args set search_path
             pdf.to_sql("regulations", db_conn, if_exists="append", index=False)
